...
class TangkwaApproveLeaveDetail extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`https://managemate.eastus.cloudapp.azure.com:8000/employee/getleave/?leaveId=${parseInt(_.last(window.location.pathname.split('/')))}`)    
        .then(res => {
    ...
    handleSetTrue = () => {
        ...
        if (window.confirm("Are you sure you want to Approve?")) {
            ...
            axios.post("https://managemate.eastus.cloudapp.azure.com:8000/employee/updateleave/",{ 
                "status": 'Approved',
